...
const handleSend = async (input: string) => {
  ...
  return (
    ...
    <main className="min-h-screen bg-gray-100 pt-2 px-2 sm:px-4 pb-6 flex justify-center font-serif">
  <div className="w-full max-w-5xl bg-gray-100 rounded-2xl flex flex-col justify-between">
        <h1 className='text-center font-bold font-serif text-3xl pt-6'>Chat With Assistant</h1>
        {/* Chat Area */}
